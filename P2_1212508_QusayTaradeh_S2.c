...
int readFile(int choiceOfPrint) // function reads file contain equations , choiceOfPrint : to choice either show contents or give No. of eqs.
{
    ...
    if(choiceOfPrint==1)
    {
        ...
        while(1) //loop will run until user enter name of file and it P2_1212508_QusayTaradeh_S2.txt
        {
            if(strcmp(nameOfFile,"P2_1212508_QusayTaradeh_S2.txt")==0)
                break;
    ...
    fptInput = fopen("P2_1212508_QusayTaradeh_S2.txt","r");
